defmodule ElixirconfChatWeb.ChatLive do
  ...
  def logo(assigns) do
    ~H"""
    <img class="my-5 md:mt-8 md:mb-7 mx-auto h-10 w-auto" src="/images/iosdevsmx-logo-clear.png" width="75" height="60" alt="" />
    """
  end
  ...
  def chat_input(assigns) do
    ...
    <form class="p-4 md:p-6" id="chat" phx-submit="post_message">
      <div class="px-2 py-[5px] flex items-center justify-between gap-x-2 border border-brand-gray-200 rounded-lg">
        ...
        <button type="submit" class="w-10 h-10 flex items-center justify-center bg-brand-green rounded-xl border-2 border-transparent group transition duration-200 hover:bg-white hover:border-brand-purple outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-purple">
